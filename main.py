...
app = FastAPI(
    ...
    description=("Receives Unreal viewport context and returns "
...
async def startup_event():
    ...
    print(
        f"✅ Response Style: {app_config.get('response_style', 'descriptive')}")
    print(
        f"✅ Conversation history: {len(conversation.conversation_history)} entries"
    )
    print(
