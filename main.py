...
RESPONSE_STYLES = {
    "descriptive": {
        ...
        "max_tokens": 400,
        "data_filter": "standard",  # Include selected + nearby context
    ...
    "technical": {
        ...
        "max_tokens": 500,
        "data_filter": "technical",  # Include technical details, transforms, exact values
    ...
    "natural": {
        ...
        "max_tokens": 300,
        "data_filter": "highlights",  # Only interesting/selected elements
    ...
    "balanced": {
        ...
        "max_tokens": 350,
        "data_filter": "balanced",  # Selected + summary of others
    ...
    "concise": {
        ...
        "max_tokens": 150,
        "data_filter": "minimal",  # Only selected objects + camera
...
# ============================================================
# INTELLIGENT DATA FILTERING SYSTEM
# ============================================================
...
def filter_viewport_data(context: 'ViewportContext', filter_mode: str) -> Dict[str, Any]:
    ...
    if filter_mode == "minimal":  # Concise: Only camera + selected
        ...
        filtered["selection"] = {
            ...
            "actors": selected_actors[:3] if len(selected_actors) > 3 else selected_actors  # Max 3
        }
        ...
        # Include only a few representative actors
        ...
        # Only mention lighting if significant
        ...
        filtered["actors"] = {
            ...
            "sample_names": actors_data.get("names", [])[:10]  # First 10 only
        }
        # Lighting summary
        filtered["lighting"] = {
    ...
    elif filter_mode == "standard":  # Descriptive: Good detail without overwhelming
        filtered["selection"] = selection_data
        filtered["actors"] = {
            "total": actors_data.get("total", 0),
            "names": actors_data.get("names", [])[:15],  # Limit to 15
            "types": actors_data.get("types", {})
        }
        filtered["lighting"] = lighting_data
        filtered["environment"] = {
            "fog": environment_data.get("fog", [])[:2],  # Max 2 fog volumes
            "landscape": environment_data.get("landscape", {})
        }
    
    elif filter_mode == "technical":  # Technical: Detailed but organized
        filtered["selection"] = selection_data
        filtered["actors"] = actors_data  # All actor data
        filtered["lighting"] = lighting_data  # Full lighting
        filtered["environment"] = environment_data  # Full environment
